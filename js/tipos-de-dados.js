...
// prettier-ignore
const text1 = "minha frase complexa com carcteres especiais sãç";
...
const object3 = {
  ...
  contatos: [
     { tipo: 'email', email: 'julianol3it3@gmail.com'},
      { tipo: 'celular', ceular: '+55 (00) 000-000-000'},
    ],
};
console.log(object3);
